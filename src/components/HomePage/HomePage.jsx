...
const HomePage = () => {
    ...
    const handleNavClick = (nav) => {
        ...
        switch (nav) {
            case 'explore':
                ...
                break;
            case 'browse':
                targetId = 'browse-subjects';
                break;
            case 'geneds':
                targetId = 'browse-geneds';
                break;
            case 'joinUs':
                targetId = 'join-block';
                break;
    ...
    useEffect(() => {
        const handleScroll = () => {
            const threshold = 50;
            const sections = [
                { id: 'main-body', nav: 'explore' },
                { id: 'browse-subjects', nav: 'browse' },
                { id: 'browse-geneds', nav: 'geneds' },
                { id: 'join-block', nav: 'joinUs' }
            ];
        ...
        <div className="container">
            <div className="nav-bar">
                ...
                <div className="nav-bar-user">
                    {user ? (
                        <>
                            <Link className="nav-bar-user-icon" to={`/user/${userInfo?.info?.userid[0]}/settings`}>
                            ...
                            <div className="nav-bar-user-icon" onClick={toggleNotificationBlock}>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="var(--text-color)">
                            ...
                            <Link className="nav-bar-user-name" to={`/user/${userInfo?.info?.userid[0]}/profile`}>
            ...
            <HomeSideBar activeNav={activeNav} onNavClick={handleNavClick} />
            <div className="main-body">
                <div className="body-info" id="main-body">
                ...
                <div className="body-details">
                    ...
                    <div className="details-card">
                        <div style={{ width: '85%', aspectRatio: '1/1' }}>
                            <CircularProgressbarWithChildren value={4.5} maxValue={5} styles={buildStyles({
                                textSize: '1rem',
                                pathColor: '#78bdff',
                                textColor: '#78bdff',
                                trailColor: 'none'
                ...
                <div className="browse-subjects" id="browse-subjects">
                    ...
                    <Link className="home-btn" to='/browse' style={{ marginRight: 'calc(3.3vw + 17px)', marginBottom: '3vh' }}>All Subjects</Link>
                </div>
                <div className="browse-geneds" id='browse-geneds'>
                    <h1>
                    ...
                    <Link className="home-btn" to='/gened'>All GenEds</Link>
                </div>
                    ...
                    <div className="feature-section">
                        <div className="feature-text-block">
                            <div className="feature-text">
                                ...
                                <div className="feature-text-dot">
                                    <div style={{ backgroundColor: 'var(--details-color-dark-red)' }}></div>
                                    <div style={{ backgroundColor: 'var(--details-color-light-red)' }}></div>
                                </div>
                            </div>
                            <div className="feature-text">
                                <h1>Feature 1</h1>
                                <p>Feature 1 description</p>
                                <div className="feature-text-dot">
                                    <div style={{ backgroundColor: 'var(--details-color-dark-yellow)' }}></div>
                                    <div style={{ backgroundColor: 'var(--details-color-light-yellow)' }}></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="feature-text-block">
                            <div className="feature-text">
                                ...
                                <p>Feature 1 description</p>
                                <div className="feature-text-dot">
                                    <div style={{ backgroundColor: 'var(--details-color-dark-blue)' }}></div>
                                    <div style={{ backgroundColor: 'var(--details-color-light-blue)' }}></div>
                                </div>
                            </div>
                            <div className="feature-text">
                                <h1>Feature 1</h1>
                                <p>Feature 1 description</p>
                                <div className="feature-text-dot">
                                    <div style={{ backgroundColor: 'var(--details-color-dark-green)' }}></div>
                                    <div style={{ backgroundColor: 'var(--details-color-light-green)' }}></div>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="join-block" id='join-block'>
                    <div className="join-title">
                        <div className="join-img" style={{ backgroundImage: `url(${feature1})` }}></div>
                        <div className="join-img" style={{ backgroundImage: `url(${feature2})` }}></div>
                        <div className="join-img" style={{ backgroundImage: `url(${feature3})` }}></div>
                        <h1>Want a more personalized experience? Join us!</h1>
                    </div>
                    <div className="join-buttons">
                        <Link className="home-btn" to="/register/login">Log In</Link>
                        <Link className="home-btn" to="/register/signup">Sign Up</Link>
                    </div>
                </div>
            </div>
            <HomeCourseBar />
